...
async function ensureStudentColumn(db: SQLite.SQLiteDatabase, table: string) {
...
async function ensureMeasurementTypesSchema(db: SQLite.SQLiteDatabase) {
...
async function ensureDefaultStudent(db: SQLite.SQLiteDatabase) {
...
export async function seedMeasurementTypesForStudent(db: SQLite.SQLiteDatabase, studentId: string) {
